...
if (empty($slug)) { header('Location: /not-found'); exit(); } 
...
require_once $_SERVER['DOCUMENT_ROOT'].'/src/config.php'; require_once $_SERVER['DOCUMENT_ROOT'].'/src/page/get_page.php'; require_once $_SERVER['DOCUMENT_ROOT'].'/src/functions/format_date_time.php'; require_once $_SERVER['DOCUMENT_ROOT'].'/src/functions/manipulate_the_element.php';

if (!$Psr16Adapter -> has($slug)) {
    $element = getPage(['slug' => $slug]);
...
$teamplate = $_SERVER['DOCUMENT_ROOT'].'/inc/page/content.phtml';
