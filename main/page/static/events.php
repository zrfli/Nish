<?php if($_SERVER['REQUEST_URI'] != '/events'){ header('Location: /not-found'); exit(); } require_once $_SERVER['DOCUMENT_ROOT'].'/inc/head/content.phtml'; require_once $_SERVER['DOCUMENT_ROOT'].'/src/functions/includeAsset.php'; require_once $_SERVER['DOCUMENT_ROOT'].'/inc/layouts/header/content.phtml'; ?> 
<main class="mt-32 mb-16 min-h-96">
    <div aria-label="events">
        <div class="px-4 mx-auto max-w-screen-xl">
            <div class="flex items-center justify-start mb-6">
                <h1 class="text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl dark:text-white">Etkinlikler</h1>
            </div>
            <div id="eventsContent" class="grid gap-8 grid sm:grid-cols-2 lg:grid-cols-3">
                <article class="flex">
                    <div class="mr-4 h-16 w-16 flex-shrink-0 overflow-hidden bg-gray-200 dark:bg-neutral-800 text-white dark:text-black animate-pulse"></div>
