...
function handleBankResponse(status) {
    ...
    if(status === 200){
        ...
        $('#nishPayContent').html(`<div class="flex items-center justify-center">
                                    ...
                                    <p class="font-bold text-lg text-black dark:text-gray-300 text-center mt-4">Ödeme Alındı!</p>
                                    <p class="text-xs text-black dark:text-gray-400 text-center mt-2">Ödemeniz başarıyla tamamlandı. Gerekli adımlar otomatik olarak sistemimiz tarafından işlenecektir. İşleminiz için teşekkür ederiz.</p>`);
    } else if(status === 400){
        $('#nishPayContent').html(`<div class="flex items-center justify-center">
                                        <div>
                                    ...
                                    <p class="font-bold text-lg text-black dark:text-gray-300 text-center mt-4">Ödeme Alınamadı!</p>
                                    <p class="text-xs text-black dark:text-gray-400 text-center mt-2">Ödemeniz başarıyla tamamlandı. Gerekli adımlar otomatik olarak sistemimiz tarafından işlenecektir. İşleminiz için teşekkür ederiz.</p>`);
    } else if(status === 500){
        $('#nishPayContent').html(`<div class="flex items-center justify-center">
                                        <div>
                                    ...
                                    <p class="font-bold text-lg text-black dark:text-gray-300 text-center mt-4">Hata!</p>
                                    <p class="text-xs text-black dark:text-gray-400 text-center mt-2">Ödemeniz başarıyla tamamlandı. Gerekli adımlar otomatik olarak sistemimiz tarafından işlenecektir. İşleminiz için teşekkür ederiz.</p>`);
    }
}